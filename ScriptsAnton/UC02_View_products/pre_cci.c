# 1 "d:\\pflb_project\\scriptsanton\\uc02_view_products\\\\combined_UC02_View_products.c"
...
# 1 "d:\\pflb_project\\scriptsanton\\uc02_view_products\\\\combined_UC02_View_products.c" 2
...
# 2 "d:\\pflb_project\\scriptsanton\\uc02_view_products\\\\combined_UC02_View_products.c" 2
...
# 3 "d:\\pflb_project\\scriptsanton\\uc02_view_products\\\\combined_UC02_View_products.c" 2
...
# 4 "d:\\pflb_project\\scriptsanton\\uc02_view_products\\\\combined_UC02_View_products.c" 2
...
Action()
{
	lr_start_transaction("UC02_View_products");
		...
		lr_start_transaction("Login");
			lr_start_transaction("UC02_TR01_Login");
				...
				web_url("384472445", 
					...
					"Mode=HTML", 
					"LAST");
			lr_end_transaction("UC02_TR01_Login",2);
		...
		lr_end_transaction("UC02_TR02_Category_select",2);
		...
		lr_start_transaction("Product_select");
			lr_start_transaction("UC02_TR03_Product_select");
				...
				web_url("product-page.html", 
					...
					"Mode=HTML", 
					"LAST");
			lr_end_transaction("UC02_TR03_Product_select",2);
		...
		lr_start_transaction("Logout");
			lr_start_transaction("UC02_TR04_Exit");
				...
				web_custom_request("AccountLogoutRequest", 
					...
					"LAST");
			lr_end_transaction("UC02_TR04_Exit",2);
		lr_end_transaction("Logout",2);
	lr_end_transaction("UC02_View_products",2);
	return 0;
}
# 5 "d:\\pflb_project\\scriptsanton\\uc02_view_products\\\\combined_UC02_View_products.c" 2
...
# 6 "d:\\pflb_project\\scriptsanton\\uc02_view_products\\\\combined_UC02_View_products.c" 2
