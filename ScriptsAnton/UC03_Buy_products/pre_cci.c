# 1 "d:\\pflb_project\\scriptsanton\\uc03_buy_products\\\\combined_UC03_Buy_products.c"
...
# 1 "d:\\pflb_project\\scriptsanton\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
...
# 2 "d:\\pflb_project\\scriptsanton\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
...
# 3 "d:\\pflb_project\\scriptsanton\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
...
# 4 "d:\\pflb_project\\scriptsanton\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
	...
	lr_start_transaction("UC03_Buy_products");
		...
		lr_start_transaction("UC03_TR02_Category_select");
			...
			web_url("category-page.html", 
				...
				"Mode=HTML", 
				"LAST");
		lr_end_transaction("UC03_TR02_Category_select",2);
		...
		lr_start_transaction("Product_select");
			...
			lr_end_transaction("UC03_TR03_Product_select",2);
		...
		lr_start_transaction("Cart_add");
			lr_start_transaction("UC03_TR04_Cart_add");
				web_submit_data("color/colors_rand", 
					...
					"LAST");
			lr_end_transaction("UC03_TR04_Cart_add",2);
		...
		lr_end_transaction("UC03_TR05_Checkout",2);
		...
		lr_start_transaction("Cart_buy");
			lr_start_transaction("UC03_TR06_Cart_buy");
				...
				web_custom_request("384472445_4", 
					...
					"LAST");
			lr_end_transaction("UC03_TR06_Cart_buy",2);
		lr_end_transaction("Cart_buy",2);
		...
		lr_start_transaction("Logout");
			lr_start_transaction("UC03_TR07_Exit");
				...
				web_custom_request("AccountLogoutRequest", 
					...
					"LAST");
			lr_end_transaction("UC03_TR07_Exit",2);
		lr_end_transaction("Logout",2);
	lr_end_transaction("UC03_Buy_products",2);
	return 0;
}
# 5 "d:\\pflb_project\\scriptsanton\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
...
# 6 "d:\\pflb_project\\scriptsanton\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
