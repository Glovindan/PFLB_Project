# 1 "d:\\pflb_project\\scriptsanton\\uc05_remove\\\\combined_UC05_Remove.c"
...
# 1 "d:\\pflb_project\\scriptsanton\\uc05_remove\\\\combined_UC05_Remove.c" 2
...
# 2 "d:\\pflb_project\\scriptsanton\\uc05_remove\\\\combined_UC05_Remove.c" 2
...
# 3 "d:\\pflb_project\\scriptsanton\\uc05_remove\\\\combined_UC05_Remove.c" 2
...
# 4 "d:\\pflb_project\\scriptsanton\\uc05_remove\\\\combined_UC05_Remove.c" 2
	...
	lr_start_transaction("UC05_Remove");	
		...
		lr_start_transaction("Cart_open");
			...
			web_url("shoppingCart.html", 
				...
				"Mode=HTML", 
				"LAST");
			lr_end_transaction("UC05_TR02_Cart_open",2);
		lr_end_transaction("Cart_open",2);
		...
		lr_end_transaction("UC05_TR03_Cart_product_remove",2);
		...
		lr_start_transaction("Logout");
			lr_start_transaction("UC05_TR04_Exit");
				...
				web_custom_request("AccountLogoutRequest", 
					...
					"LAST");
			lr_end_transaction("UC05_TR04_Exit",2);
		lr_end_transaction("Logout",2);
	lr_end_transaction("UC05_Remove", 2);
	return 0;
}
# 5 "d:\\pflb_project\\scriptsanton\\uc05_remove\\\\combined_UC05_Remove.c" 2
...
# 6 "d:\\pflb_project\\scriptsanton\\uc05_remove\\\\combined_UC05_Remove.c" 2
