		...
		lr_start_transaction("Login");
			lr_start_transaction("UC02_T01_Login");
				...
				web_url("{user_id}", 
					...
					"Mode=HTML", 
					LAST);
			lr_end_transaction("UC02_T01_Login",LR_AUTO);
		lr_end_transaction("Login", LR_AUTO);
		
		lr_think_time(27);
		
		lr_start_transaction("Category_select");
			lr_start_transaction("UC02_T02_Category_select");
				web_reg_save_param_json(
			...
			lr_end_transaction("UC02_T02_Category_select",LR_AUTO);
		lr_end_transaction("Category_select", LR_AUTO);
	
		lr_think_time(26);
		lr_start_transaction("Product_select");
			lr_start_transaction("UC02_T03_Product_select");
				web_url("all_data", 
				...
				web_url("product-page.html", 
					...
					"Mode=HTML", 
					LAST);
			lr_end_transaction("UC02_T03_Product_select",LR_AUTO);
		...
		lr_start_transaction("Logout");
			lr_start_transaction("UC02_T04_Logout");
				...
				web_custom_request("AccountLogoutRequest", 
					...
					LAST);
			lr_end_transaction("UC02_T04_Logout",LR_AUTO);
