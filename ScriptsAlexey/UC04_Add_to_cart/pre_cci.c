# 1 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc04_add_to_cart\\\\combined_UC04_Add_to_cart.c"
...
# 1 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc04_add_to_cart\\\\combined_UC04_Add_to_cart.c" 2
...
# 2 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc04_add_to_cart\\\\combined_UC04_Add_to_cart.c" 2
...
# 3 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc04_add_to_cart\\\\combined_UC04_Add_to_cart.c" 2
...
# 4 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc04_add_to_cart\\\\combined_UC04_Add_to_cart.c" 2
...
Action()
{
	...
	lr_end_transaction("UC04_T01_login",2);
	...
	lr_start_transaction("UC04_T02_category_selection");
	...
	lr_end_transaction("UC04_T02_category_selection",2);

	lr_think_time(30);

	lr_start_transaction("UC04_T03_product_selection");
...
# 294 "Action.c"
	...
	lr_end_transaction("UC04_T03_product_selection",2);

	lr_start_transaction("UC04_T04_add_to_cart");
	...
	lr_end_transaction("UC04_T04_add_to_cart",2);
	...
	lr_end_transaction("UC04_T05_logout",2);

	return 0;
}
# 5 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc04_add_to_cart\\\\combined_UC04_Add_to_cart.c" 2
...
# 6 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc04_add_to_cart\\\\combined_UC04_Add_to_cart.c" 2
