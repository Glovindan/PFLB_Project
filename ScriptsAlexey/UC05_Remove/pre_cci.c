# 1 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc05_remove\\\\combined_UC05_Remove.c"
...
# 1 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc05_remove\\\\combined_UC05_Remove.c" 2
...
# 2 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc05_remove\\\\combined_UC05_Remove.c" 2
...
# 3 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc05_remove\\\\combined_UC05_Remove.c" 2
...
# 4 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc05_remove\\\\combined_UC05_Remove.c" 2
...
# 215 "Action.c"
	...
	lr_end_transaction("UC05_T01_Login",2);
	...
	lr_start_transaction("UC05_T02_go_to_orders");
...
# 234 "Action.c"
	...
	lr_end_transaction("UC05_T02_go_to_orders",2);

	lr_think_time(40);

	lr_start_transaction("UC05_T03_remove_products");
	...
	web_custom_request("55CDD5", 
		...
		lr_error_message("Корзина пуста!");
	}
	lr_end_transaction("UC05_T03_remove_products",2);
	...
	lr_end_transaction("UC05_T04_logout",2);

	return 0;
}
# 5 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc05_remove\\\\combined_UC05_Remove.c" 2
...
# 6 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc05_remove\\\\combined_UC05_Remove.c" 2
