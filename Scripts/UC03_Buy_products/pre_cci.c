# 1 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc03_buy_products\\\\combined_UC03_Buy_products.c"
...
# 1 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
...
# 2 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
...
# 3 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
...
# 4 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
...
Action()
{
	...
	lr_end_transaction("UC03_T01_Login",2);
...
# 229 "Action.c"
	...
	lr_start_transaction("UC03_T02_category_selection");
	...
	lr_end_transaction("UC03_T02_category_selection",2);

	lr_think_time(34);

	lr_start_transaction("UC03_T03_product_selection");
	...
	lr_end_transaction("UC03_T03_product_selection",2);

	lr_think_time(30);

	lr_start_transaction("UC03_T04_product_addition");
	...
	lr_end_transaction("UC03_T04_product_addition",2);
	...
	lr_end_transaction("UC03_T05_Checkout",2);

	lr_start_transaction("UC03_T06_product_purchase");
	...
	lr_end_transaction("UC03_T06_product_purchase",2);
	...
	lr_end_transaction("UC03_T07_Logout",2);
	
	lr_end_transaction("UC03_Buy_products", 2);

	return 0;
}
# 5 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
...
# 6 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc03_buy_products\\\\combined_UC03_Buy_products.c" 2
