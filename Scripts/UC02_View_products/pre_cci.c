# 1 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc02_view_products\\\\combined_UC02_View_products.c"
...
# 1 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc02_view_products\\\\combined_UC02_View_products.c" 2
...
# 2 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc02_view_products\\\\combined_UC02_View_products.c" 2
...
# 3 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc02_view_products\\\\combined_UC02_View_products.c" 2
...
# 4 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc02_view_products\\\\combined_UC02_View_products.c" 2
...
Action()
{
	...
	web_add_cookie("_gid=GA1.2.434099252.1670609043; DOMAIN=advantageonlineshopping.com");
...
# 166 "Action.c"
	...
	lr_start_transaction("UC02_T01_Login");
	...
	lr_end_transaction("UC02_T01_Login",2);
	...
	lr_start_transaction("UC02_T02_category_selection");
	...
	lr_end_transaction("UC02_T02_category_selection",2);

	lr_think_time(26);

	lr_start_transaction("UC02_T03_product_selection");
	...
	lr_end_transaction("UC02_T03_product_selection",2);

	lr_start_transaction("UC02_T04_Logout");
	...
	lr_end_transaction("UC02_T04_Logout",2);

	lr_end_transaction("UC02_View_products", 2);

	return 0;
}
# 5 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc02_view_products\\\\combined_UC02_View_products.c" 2
...
# 6 "c:\\users\\alexey\\documents\\vugen\\scripts\\uc02_view_products\\\\combined_UC02_View_products.c" 2
